...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            Log.d("Checking", "Saved Instance State Loaded")
        } else {
            currentIndex = 0
            Log.d("Checking", "No Saved Instance State")
        }
        ...
        ArrowLeftBtn.setOnClickListener {
            ...
            showCar()
            Log.d("Checking", "Car Changed Backward")
        }
        ...
        RentBtn.setOnClickListener {
            ...
            Log.d("Checking", "Change to Rent Page")
        }
        ...
        FavouriteBtn.setOnClickListener {
            ...
            startActivity(intent)
            Log.d("Checking", "Change to Favourite Page")
        }
        ...
        DetailsBtn.setOnClickListener {
            ...
            startActivity(intent)
            Log.d("Checking", "Change to Details Page")
        }
        ...
        DarModeSwh.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (isChecked) {
                ...
                Log.d("Checking", "Dark Mode Toggled")
            } else {
                AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO)
                Log.d("Checking", "Light Mode Toggled")
            }
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Log.d("Checking", "Saved Instance State Saved")
    }
}